    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-100 via-blue-50/60 to-indigo-100/40">
      <div className="page-container">
        ...
        <div className="mb-8 flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4">
          ...
          {/* Today badge */}
          <div className="shrink-0 flex items-center gap-2 px-4 py-2 bg-white/70 backdrop-blur-sm border border-white/60 rounded-xl shadow-sm text-sm font-semibold text-slate-600">
